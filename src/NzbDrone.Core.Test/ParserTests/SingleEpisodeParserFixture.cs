...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class SingleEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("Series: Legacy (S2E1) (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Series: Legacy", 2, 1)]
        [TestCase("Series: Legacy / S2E1 of 10 (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Series: Legacy", 2, 1)]
