...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class SingleEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("Босх: Спадок (S2E1) / Series: Legacy (S2E1) (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Босх: Спадок", 2, 1)]
        [TestCase("Босх: Спадок / Series: Legacy / S2E1 of 10 (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Босх: Спадок", 2, 1)]
