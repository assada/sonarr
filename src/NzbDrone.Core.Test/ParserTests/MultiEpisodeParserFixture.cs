...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class MultiEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("Series: Legacy (S2E1-4) (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Series: Legacy", 2, new[] { 1, 2, 3, 4 })]
        [TestCase("Series: Legacy / S2E1-4 of 10 (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Series: Legacy", 2, new[] { 1, 2, 3, 4 })]
