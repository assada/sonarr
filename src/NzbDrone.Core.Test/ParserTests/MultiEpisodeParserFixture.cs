...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class MultiEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("Босх: Спадок (S2E1-4) / Series: Legacy (S2E1-4) (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Босх: Спадок", 2, new[] { 1, 2, 3, 4 })]
        [TestCase("Босх: Спадок / Series: Legacy / S2E1-4 of 10 (2023) WEB-DL 1080p Ukr/Eng | sub Eng", "Босх: Спадок", 2, new[] { 1, 2, 3, 4 })]
